...
class AppSources {
  ...
  static String surahAudioUrl(int surahNumber, {String reciter = 'ar.alafasy'}) =>
      'https://cdn.islamic.network/quran/audio-surah/$_audioBitrate/$reciter/$surahNumber.mp3';
