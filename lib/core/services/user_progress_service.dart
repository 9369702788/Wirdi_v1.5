...
class UserProgressService {
  ...
  /// Real per-day activity for the last 7 days (today + 6 previous),
  /// built from the same date-keyed storage already used for Azkar
  /// completion and prayer tracking, plus the newly date-keyed wird
  /// pages and Tasbeeh daily totals. This is a genuine history log, not
  /// a derived guess — each day's numbers were written on that day.
